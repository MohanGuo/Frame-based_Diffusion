...
class E_GCL_mask(E_GCL):
    ...
    def coord_model(self, coord, edge_index, coord_diff, edge_feat, edge_mask):
        ...
        # coord_diff = coord_diff / radial.unsqueeze(1)
        coord_diff_norm = F.normalize(coord_diff, p=2, dim=1, eps=1e-6)
        # coord_diff_norm = coord_diff
        trans = torch.einsum('bij,bci->bcj', coord_matrix, coord_diff_norm)
